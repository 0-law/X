# 0律 - 全域演化协议
# 0-Law: Universal Evolution Protocol

## 项目简介 | Project Introduction

本项目记录全域演化协议（0律）的架构与推演过程。
This project documents the architecture and deduction process of the Universal Evolution Protocol (0-Law).
